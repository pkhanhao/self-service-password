...
if ( $result === "sendsms" ) {
    ...
    # Send message
    if ( send_mail($smsmailto, $mail_from, $smsmail_subject, $sms_message, $data, $smtp_params) ) {
...
if ( $result === "redirect" ) {
    ...
    $reset_url = $method."://".$http_host.$script_name."?action=resetbytoken&token=$token&source=sms";
