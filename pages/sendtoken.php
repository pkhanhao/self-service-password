...
if ( $result === "" ) {
    ...
    $reset_url = $method."://".$http_host.$script_name."?action=resetbytoken&token=$token";
    ...
    # Send message
    if ( send_mail($mail, $mail_from, $messages["resetsubject"], $messages["resetmessage"], $data, $smtp_params) ) {
        $result = "tokensent";
    } else {
        $result = "tokennotsent";
