...
$messages['changehelp'] = "输入您的用户名、旧密码并设置新密码.";
...
$messages['resetmessage'] = "{login} 您好，\n\n点击或复制以下链接到浏览器中，以重置您的密码:\n{url}\n\n注意：此链接有效期为30分钟，如需获取新的重置链接，请30分钟后重试！\n\n[如果您没有请求修改密码，请忽略该邮件。]";
...
$messages['tokensent'] = "重置密码邮件已发出，请注意查收邮件";
